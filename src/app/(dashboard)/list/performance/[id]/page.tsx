...
export default function StudentPerformanceFull() {
  ...
  const [admin, setAdmin] = useState<any>({ name: "Admin Name" }); // placeholder
  ...
  const handleGenerateReport = () => {
    ...
    // --- Footer ---
    doc.setFontSize(10);
    doc.text(`Report generated by ${admin?.name || "Admin"}`, margin, 820);
  ...
  return (
    <div className="p-4 bg-primary-light rounded-md m-4 mt-0">
      <div className="flex items-center gap-4 mb-4">
        ...
        <button
          onClick={() => handleGenerateReport(student, admin.name)}
